...
class Forecasting(object):
	...
	def get_sales_transactions_based_on_items(self):
		...
		filters = {
			"docstatus": 1,
			"sales_invoice": self.filters.posting_date,
			self.date_field: ('between', [self.filters.from_date, self.filters.to_date])
		}
		...
		"""
		.format(date_field_filters=date_field_filters,conditions=conditions,date_field=self.date_field, value_field=value_field, doctype=self.filters.based_on_document),
